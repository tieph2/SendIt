...
export class Migration20230522075940 extends Migration {
	async up(): Promise<void> {
		this.addSql(
			'create table "boulders" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "zone" int not null, "color" varchar(255) not null, "score" int not null, "grade" int not null, "note" varchar(255) not null);'
		);
		...
		this.addSql(
			'create table "users" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "email" varchar(255) not null, "name" varchar(255) not null, "skill_level" int not null, "password" varchar(255) not null default \'password\', "role" text check ("role" in (\'Admin\', \'User\', \'Judge\')) not null);'
		);
